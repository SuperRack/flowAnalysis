...
<body>
            ...
            <div id="page-inner">
				 <div class="col-md-12" style="margin-bottom:20px;">
	                ...
	                <ul class="nav nav-tabs">
	                	<li role="presentation" class="active"><a href="${basePath }/flow/findUpDownByPro">全部</a></li>
	            ...
	            <div class="seach-form" style="margin-left:20px;">
		            <form class="form-inline" method="post" action="${basePath }/flow/findUpDownByPro">
	            ...
	            <br/>
	            <h4 style="margin-left:20px;color:#d43f3a;">柱状图显示</h4>
	            <div id="columnMain" style="width: 1100px;height:500px;"></div>
            </div>
            <!-- /. PAGE INNER  -->
        </div>
        <!-- /. PAGE WRAPPER  -->
    ...
    <script type="text/javascript">
    var app = echarts.init(document.getElementById('columnMain'));
    var option = {
    		tooltip: {},
    		toolbox: {
